...
export const LocationPicker: React.FC<LocationPickerProps> = ({ onLocationSelected, initialPos }) => {
  const [position, setPosition] = useState<L.LatLng>(
    initialPos ? L.latLng(initialPos[0], initialPos[1]) : L.latLng(-0.502106, 117.153709) // Default Samarinda
  );
    ...
    <div className="w-full h-full relative font-sans">
      ...
      <div className="absolute bottom-4 left-4 right-4 z-[1000] bg-white p-4 rounded-2xl shadow-xl border border-slate-200 text-left">
          <div className="flex items-start gap-3">
              ...
              <div>
                  <h4 className="text-[10px] font-black uppercase text-slate-400 tracking-widest leading-none mb-1">Lokasi Terpilih</h4>
